...
public class Items { // class Items

    public int itemQuantity; // itemQuantity variable of type int

    public Items() { // constructor for Items class
        this.itemQuantity = 0; // set itemQuantity to 0
    }

    public static void main(String[] args) {
        ArrayList<Items> items = new ArrayList<>(); // Create an ArrayList object called items
            ...
            switch (choice) { // switch statement for the menu options
                case 1 -> {
                    ...
                    if (item == 1) { // if statement for the first option in the food menu
                        ...
                        items.add(new Items()); // add the item to the ArrayList called items
